    ...
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="card space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label className="form-label">Assessment / KCPE Number</label>
            <input
              type="text"
        ...
        {/* Class & Parent */}
        <p className="text-xs uppercase tracking-widest text-teal-600 font-semibold pt-2">Class & Parent</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
          ...
          <div>
            <label className="form-label">Parent / Guardian ID *</label>
            <input
              type="number"
              name="parent"
              className="milk-input"
